...
use <code><tab></code> to do auto completion. (only java-base api, by plugin/vjde)

use <code><C-x><C-o></code> to do omni-completion. (by plugin/javacomplete)

h2. Play! Framework Support
...
h2. Customize Vim leader key

set leader key from <code>\</code> to <code>,</code>

Warning: plugin.bufexplorer couldn't use now...
