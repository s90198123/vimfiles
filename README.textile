...
use command 'curl'
<pre> <code> curl -o - https://raw.github.com/s90198123/vimfiles/master/install.sh | sh </code> </pre>

or 'wget'
<pre> <code> wget -O - https://raw.github.com/s90198123/vimfiles/master/install.sh | sh </code> </pre>
